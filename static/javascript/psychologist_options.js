let selectedUserType = null;
        ...
        function showUserTypeSelector() {
            document.querySelectorAll('.user-type-selector').forEach(el => {
                el.classList.remove('active');
            });
            
            document.getElementById('soldier-type-selector').classList.add('active');
        }
        
        function hideUserTypeSelector() {
            document.getElementById('soldier-type-selector').classList.remove('active');
        }
        ...
        function selectUserType(type) {
            ...
            if (type === 'soldier') {
                showDateTimeSelector('soldier');
            } else if (type === 'evacuee') {
                showDateTimeSelector('evacuee');
            }
        }
